...
for(var b=document.getElementsByTagName("input"),c=0;
c<b.length;
c++)if("hidden"==b[c].type&&32==b[c].name.length&&"1"==b[c].value)b[c].name=a}
;
...
b||(b="cb");
if(a.form){
for(var c=0,d=0,f=a.form.elements.length;
d<f;
d++){
...
for(var c=0;
c<b;
c++)if(a[c].checked)return a[c].value;
return""}
...
if(a.form.boxchecked)a.form.boxchecked.value=c;
return!0}
for(var e=document.adminForm,c=e.toggle.checked,f=a,g=0,d=0;
d<f;
d++){
var h=e[b+""+d];
if(h)h.checked=c,g++}
